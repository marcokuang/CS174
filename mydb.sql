...
--
-- Host: localhost
-- Generation Time: Dec 01, 2015 at 08:18 PM
...
(2, 7, 'To Do first paragraph', '2015-10-16 00:00:00'),
(1, 8, 'Todo second paragraph', '2015-10-09 00:00:00');
...
--
ALTER TABLE `ProjectTodoTable`
  MODIFY `ProjectTodoID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
ALTER TABLE `UserTodoTable`
  ...
  ADD CONSTRAINT `fk_UserTodoTable_2` FOREIGN KEY (`ProjectID`) REFERENCES `ProjectTodoTable` (`ProjectID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
